 ...
 * It retuns an integer value indicating theirr relationship:
 * - 0 If both strings are equal
 * - a negative value if @string1 is lexicographically smaller than @string2
 * - a poitive value iif @string2 is lexicographically smaller than @string1
 *
 * Return: The comparison result as decribed above.
 */
...
/**
 * _str_cat - a function that concatentes two strings
