 ...
 * This function sets an environment varible with the given name (variable)
 * to the provided value. If the operaion fails, it prints an error message
 * to the standard error stream.
 *
 * @variable: The name of the environment variable to set.
 * @value: The value to assign to the eenvironment variable.
 */
 ...
 * This function unsets (removes) the environment variable with the specific
 * name (variable)). If the operation fails, it prints an error message to
...
/**
 * change_directory - Change the current workingg directory
